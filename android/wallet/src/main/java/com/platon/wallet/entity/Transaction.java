...
public class Transaction implements Comparable<Transaction>, Parcelable, Cloneable {
     ...
     * 发送者钱包名称
     */
    public String senderWalletName;
    /**
     * {json}交易详细信息
     */
    ...
    public String unDelegation;
    /**
     * 质押金额 txType = 1003(退回数量)
     */
    public String stakingValue;
    /**
    ...
    public Transaction(Builder builder) {
        ...
        this.rAddress = builder.rAddress;
    ...
    private boolean isContainIgnoreCase(List<String> queryAddressList, final String address) {
    ...
    public static final class Builder {
        ...
        public Builder rAddress(String rAddress){
            this.rAddress = rAddress;
            return this;
        }
    ...
    public TransactionEntity buildTransactionEntity(){
        return new TransactionEntity.Builder(getHash(),getWalletName(),getFrom(),getTo(),getTimestamp())
//                .setBlockNumber(Long.parseLong(getBlockNumber()))
                .setValue(Double.parseDouble(getValue()))
                .setContractAddress(getContractAddress())
                .setSymbol(getSymbol())
                .setRAddress(getRAddress())
                .setAssetId(getAssetId())
                .setTxType(String.valueOf(getTxType()))
                .setTxReceiptStatus(getTxReceiptStatus())
