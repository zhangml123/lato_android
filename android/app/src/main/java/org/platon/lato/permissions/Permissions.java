package org.platon.lato.permissions;
...
import org.platon.lato.util.LRUCache;
import org.platon.lato.util.ServiceUtil;
...
public class Permissions {
  ...
  private static void onRequestPermissionsResult(@NonNull PermissionObject context, int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
    System.out.println("Permissions11  onAnyResult222");
